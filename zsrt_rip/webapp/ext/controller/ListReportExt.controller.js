    ...
    return {
        ...
        _showResultDialog: function (aResults) {
            ...
            const oTable = new sap.m.Table({
                ...
                growingThreshold: 50,
                columns: [
                    new sap.m.Column({ header: new sap.m.Text({ text: "RIP Number" }) }),
            ...
            oTable.bindItems({
                ...
                template: new sap.m.ColumnListItem({
                    cells: [
                        new sap.m.Text({ text: "{mrvonr}" }),
                        new sap.m.Text({ text: "{object_type}" }),
                        new sap.m.Text({ text: "{rvonr}" }),
                        new sap.m.Text({ text: "{processingID}" }),
                        new sap.m.Text({ text: "{CreatedRIP}" }),
